...
use lib::microservice::FirebaseRtdb;
use uuid::Uuid;
...
/// `lib::FirebaseRtdb` (a reqwest-based client already used by the
...
// `FirebaseRtdb` in apps/shared doesn't implement Debug; provide a stub so
