...
/// Converts our request-local transform into the apps/shared type.
fn to_lib_transform(t: &VideoTransformRequest) -> lib::microservice::VideoTransform {
    lib::microservice::VideoTransform {
        rotation: t.rotation,
